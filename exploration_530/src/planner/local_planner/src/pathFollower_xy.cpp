  ...
  while (status) {
    ...
    if (pathInit) {
      ...
      if ( fabs(disX) > stopDisThre) {
        if(disX > stopDisThre)
        {
        if (vehicleSpeed_X < joySpeed3) vehicleSpeed_X += maxAccel / 100.0;
        else if (vehicleSpeed_X > joySpeed3) vehicleSpeed_X -= maxAccel / 100.0;
        }
        else
        {
        if (vehicleSpeed_X < joySpeed3) vehicleSpeed_X += maxAccel / 100.0;
      ...
      if ( fabs(disY) > stopDisThre) {
        // if (vehicleSpeed_Y < joySpeed3) vehicleSpeed_Y += maxAccel / 100.0;
        // else if (vehicleSpeed_Y > joySpeed3) vehicleSpeed_Y -= maxAccel / 100.0;
        if(disY > stopDisThre)
        {
        if (vehicleSpeed_Y < joySpeed3) vehicleSpeed_Y += maxAccel / 100.0;
        else if (vehicleSpeed_Y > joySpeed3) vehicleSpeed_Y -= maxAccel / 100.0;
