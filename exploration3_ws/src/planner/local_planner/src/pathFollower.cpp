...
int main(int argc, char** argv)
{
  ...
  while (status) {
    ...
    if(nav_disX<=0.15 && nav_disY<=0.15)
    {
      navpoint_state = true;
    }
    else
    ...
    if (pathInit) {
      ...
      float dirDiff_x = vehicleYaw - vehicleYawRec - pathDir_x;
      ...
      float dirDiff_y = vehicleYaw - vehicleYawRec - pathDir_y;
      ...
      if (pubSkipCount < 0) {
        ...
        // float map_vx = cos(vehicleYaw)*vehicleSpeed_X - sin(vehicleYaw)*vehicleSpeed_Y;
        // float map_vy = sin(vehicleYaw)*vehicleSpeed_X + cos(vehicleYaw)*vehicleSpeed_Y;
        // printf("map_vx: %f , map_vy: %f \n",map_vx,map_vy);
        // printf("map_v: %f \n",map_vy/map_vx);
        ...
        // vehicleSpeed_X = 1.0;
        // vehicleSpeed_Y = 0.0;
        float vehicleSpeed_X2 = cos(vehicleYaw)*vehicleSpeed_X - sin(vehicleYaw)*vehicleSpeed_Y;
        float vehicleSpeed_Y2 = sin(vehicleYaw)*vehicleSpeed_X + cos(vehicleYaw)*vehicleSpeed_Y;
